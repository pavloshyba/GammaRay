...
void ConnectPage::validateHostAddress(const QString &address)
{
    ...
    QRegularExpression re(QRegularExpression::anchoredPattern(QStringLiteral("^([a-zA-Z][a-zA-Z0-9\\-\\.]+[a-zA-Z0-9](:[0-9]{1,5})?)$")));
...
void ConnectPage::handleIPAddress(QString &stillToParse, bool &correctSoFar)
{
    ...
    QRegularExpression bracketFormatRE(QRegularExpression::anchoredPattern(QStringLiteral(R"(^\[([0-9a-f\:\.]*)\].*$)")));
    ...
    QRegularExpression interfaceFormatRE(QRegularExpression::anchoredPattern(QStringLiteral(R"(^\[([0-9a-f\:\.]*)\].*$)")));
...
{
    QRegularExpression re(QRegularExpression::anchoredPattern(QStringLiteral(R"(^\[([0-9a-f\:\.]*)\].*$)")));
